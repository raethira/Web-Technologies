...
public class Get_search_results {
    ...
    public Get_search_results(String icon, String name, String address, String heart, String placeid,Double to_lat, Double to_lng) {
        this.icon = icon;
        this.name = name;
